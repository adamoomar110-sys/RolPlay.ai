...
# --- MAIN APP REGION ---
st.set_page_config(page_title="RolPlay.ai v1.3 Premium", page_icon="🎭", layout="wide")
...
st.markdown('<div class="footer">© 2026 RolPlay.ai v1.3 Premium | Inteligencia Local Qwen 2.5</div>', unsafe_allow_html=True)
